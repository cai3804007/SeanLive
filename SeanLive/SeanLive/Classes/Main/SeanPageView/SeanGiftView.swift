...
protocol SeanGiftViewDataSource :class {
...
class SeanGiftView: UIView {
    ...
    // MARK:- 外部属性
    var dataSource : SeanGiftViewDataSource?
    var delegate : SeanGiftViewDelegate?
    ...
    init(frame: CGRect, titles : [String], style : SeanPageViewStyle, isTitleTop : Bool,layout : SeanGiftLayout) {
        self.titles = titles
        self.style = style
...
// MARK:- 对外暴露方法
extension SeanGiftView {
    func registerCell(cell : AnyClass?, idenfier : String ){
